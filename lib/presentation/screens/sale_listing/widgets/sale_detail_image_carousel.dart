// lib/presentation/screens/sale_listing/widgets/sale_detail_image_carousel.dart

import 'package:flutter/material.dart';
import 'package:cached_network_image/cached_network_image.dart';
import '../../../../core/theme/app_colors.dart';

class SaleDetailImageCarousel extends StatefulWidget {
  final List<String> imageUrls;

  const SaleDetailImageCarousel({
    super.key,
    required this.imageUrls,
  });

  @override
  State<SaleDetailImageCarousel> createState() => _SaleDetailImageCarouselState();
}

class _SaleDetailImageCarouselState extends State<SaleDetailImageCarousel> {
  ...
  @override
  void didUpdateWidget(SaleDetailImageCarousel oldWidget) {
